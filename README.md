...
2. Ejecutar `npm run dev` para levantar el servidor de desarrollo.
3. Navegar a `http://localhost:5173/`

# Curso Udemy OpenAI: Ejercicios practicos y asistentes con React + NestJS (Fernando Herrera)
...
- Seccion 11: Frontend - Audio a texto
